...
export default class Player extends Character {
    ...
    public override getSkillDamageLevel(): number {
        ...
        return Math.max(1, Math.round(this.getStrengthLevel() * this.talents.getPhysicalDamageMultiplier()));
    }
    ...
    public override getDamageType(): Modules.Hits {
        if (!this.isMagic() && !this.isArcher() && Utils.randomFloat(0, 100) <= this.talents.getCriticalChance())
