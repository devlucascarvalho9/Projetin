...
export default abstract class Entity {
    ...
    public setSprite(sprite: Sprite): void {
        ...
        sprite.onLoad(() => {
            // Player scaling is handled by the renderer around a stable grid/feet anchor.
            // Mutating the shared sprite offsets here would shift the player a second time.
            if (!this.customScale || this.isPlayer()) return;
