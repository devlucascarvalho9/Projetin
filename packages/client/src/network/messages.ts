...
export default class Messages {
    ...
    private talentCallback?: TalentPacketCallback;
    ...
    public constructor(private app: App) {
        ...
        this.messages[Packets.Talent] = () => this.talentCallback;
    }
    ...
    public onTalent(callback: TalentPacketCallback): void {
        this.talentCallback = callback;
    }
}
