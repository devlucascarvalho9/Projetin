    ...
    private async handlePlayerCommands(command: string, blocks: string[]): Promise<void> {
        switch (command) {
            ...
            case 'cidadeestruturada': {
                // AUDIT-NATIVE: real native 16x12 Love map. No HTML/CSS world-art overlay.
                this.player.teleport(392, 1062, true, false, true);
                return this.player.notify('Mapa do Amor nativo auditado — 16x12 tiles.');
            }
            ...
            case 'teleportes':
            case 'tps': {
                this.player.notify('/amor ou /cidade — Mapa do Amor NATIVO auditado (16x12)');
                this.player.notify('/carverna, /caverna ou /cave — Caverna Tiled NATIVA (80x64)');
