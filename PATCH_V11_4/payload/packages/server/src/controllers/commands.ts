...
export default class Commands {
    ...
    private async handlePlayerCommands(command: string, blocks: string[]): Promise<void> {
        switch (command) {
            ...
            case 'cidade':
            case 'city': {
                // V11.4: moved back inside the runtime-valid world into a fully cleared reserved zone.
                this.player.teleport(36, 766, true, false, true);
                return this.player.notify('Cidade Ilustrada V11.4 — area limpa dentro do mapa valido, com estruturas reais.');
            }

            case 'amor':
            case 'love': {
                // V11.4: Carine Love Map integrated into a separate clean reserved region.
                this.player.teleport(45, 651, true, false, true);
                return this.player.notify('Mapa do Amor — Carine Eu Te Amo. Use /cidade para voltar.');
            }

            case 'cidade2':
            case 'cidadeestruturada': {
                this.player.teleport(88, 1081, true, false, true);
                return this.player.notify('Cidade Estruturada V11.1 mantida para comparacao.');
            }

            case 'cidadeantiga':
            case 'oldcity': {
                this.player.teleport(36, 766, true, false, true);
                return this.player.notify('A cidade ilustrada continua como cidade principal. Use /cidade2 apenas para comparacao.');
            }
            ...
            case 'teleportes':
            case 'tps': {
                this.player.notify('/cidade — Cidade Ilustrada V11.4 (area limpa + estruturas reais)');
                this.player.notify('/amor — Carine Love Map em uma area limpa separada');
                this.player.notify('/dungeon — Cripta procedural V11.0 / Crypt Lord');
                this.player.notify('/cidade2 — Cidade Estruturada V11.1, mantida para comparacao');
