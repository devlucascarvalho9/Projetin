...
export default class Commands {
    ...
    private async handlePlayerCommands(command: string, blocks: string[]): Promise<void> {
        switch (command) {
            ...
            case 'cidade':
            case 'city': {
                // Central plaza landing point for the animated starter city overlay.
                // Kept away from the new structure/water collision mask.
                this.player.teleport(191, 160, true, false, true);
                return this.player.notify('Teleportado para a Cidade Inicial Animada.');
            }
