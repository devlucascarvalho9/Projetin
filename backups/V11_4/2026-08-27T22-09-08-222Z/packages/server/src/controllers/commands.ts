...
export default class Commands {
    ...
    private async handlePlayerCommands(command: string, blocks: string[]): Promise<void> {
        switch (command) {
            ...
            case 'cidade':
            case 'city': {
                // V11.2: the preferred illustrated city was moved wholesale to a blank
                // extension of the world. The 782 structure/water collision cells move with it.
                this.player.teleport(200, 1086, true, false, true);
                return this.player.notify('Cidade Ilustrada V11.3 — spawn movido para a avenida sul e piso caminhavel corrigido.');
            }
            ...
            case 'oldcity': {
                this.player.teleport(200, 1086, true, false, true);
                return this.player.notify('A cidade ilustrada agora e a cidade principal V11.3. Use /cidade2 para comparar com a estruturada.');
            }
            ...
            case 'teleportes':
            case 'tps': {
                this.player.notify('/cidade — Cidade Ilustrada V11.2 (arte bonita + colisoes reais)');
                ...
                return this.player.notify('O seletor MAPAS da interface tambem possui os novos destinos.');
            }
