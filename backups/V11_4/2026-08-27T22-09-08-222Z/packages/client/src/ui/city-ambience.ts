 ...
 * V11.2 moves this art to an empty world extension; server-side native collision tiles provide structures/water.
 */
export default class CityAmbience {
    ...
    private readonly originGridX = 180;
    private readonly originGridY = 1056;
