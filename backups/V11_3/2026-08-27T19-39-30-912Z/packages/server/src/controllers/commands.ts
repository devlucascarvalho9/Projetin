    ...
    private async handlePlayerCommands(command: string, blocks: string[]): Promise<void> {
        switch (command) {
            ...
            case 'city': {
                ...
                this.player.teleport(203, 1076, true, false, true);
                return this.player.notify('Cidade Ilustrada V11.2 — arte antiga bonita, agora em terreno vazio com estruturas e agua solidas.');
            }
            ...
            case 'oldcity': {
                this.player.teleport(203, 1076, true, false, true);
                return this.player.notify('A antiga cidade ilustrada agora e a cidade principal V11.2. Use /cidade2 para comparar com a estruturada.');
            }
            ...
            case 'itemlist': {
                ...
                return this.player.notify(`Use /giveitem <key> [qtd] [normal|magic|rare|unique] [ilvl].`);
            }
