...
export default class Game {
    ...
    private openWorldMapSelector(): void {
        ...
        const destinations = [
            {
                id: -1,
                name: 'Cidade Inicial Animada',
                biome: 'meadow' as BiomeId,
                biomeName: 'Cidade Viva',
                requirement: 'Comando /cidade também disponível',
                description: 'Nova cidade principal com água, árvores, fumaça, fonte e luzes animadas.'
            },
            {
                id: 0,
                name: 'Mudwich',
        ...
        const selectDestination = (id: number, biome: BiomeId) => {
            ...
            if (id === -1) this.socket.send(Packets.Chat, ['/cidade']);
    ...
    private openRoadmapSystem(kind: 'character'|'skills'|'dungeons'|'bosses'|'endgame'|'idle'): void {
        ...
        const content:Record<string,{title:string;html:string}>={
            ...
            dungeons:{title:'🚪 Dungeons',html:'<p>Sistema-base preservado. As zonas existentes agora alimentam o loot ARPG por nível e Item Level.</p><p>Instâncias próprias e boss final continuam como expansão futura, fora dos 7 módulos deste roadmap.</p>'},
